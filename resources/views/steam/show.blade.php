                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body pb-0">
                                ...
                                @else
                                    <h5 class="card-title">Dit spel heeft geen naam</h5>
                                @endif
                                @if (isset($selectedGameInfo['short_description']))
                                    <h class="card-title">{{ $selectedGameInfo['short_description'] }} | speeltijd: {{ $selectedGameInfo['playtime_forever'] }}</h>
                                @else
                                    <h class="card-title">Dit spel heeft geen beschrijving</h>
                                @endif
                            </div>
                        </div>
