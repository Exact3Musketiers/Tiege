...
@section('content')
    ...
    <div id="lyricsbox" class="mx-auto text-center mb-5">
        ...
        <button class="btn btn-dark" onclick="changeFont(true)"><i class="fas fa-font"></i><i class="fas fa-plus"></i>
        </button>
        <button class="btn btn-dark" onclick="changeFont(false)"><i class="fas fa-font"></i><i class="fas fa-minus"></i>
        </button>
