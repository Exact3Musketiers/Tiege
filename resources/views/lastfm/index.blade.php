                                    ...
                                    @foreach($data->topAlbums->album as $album)
                                        ...
                                        @else
                                            <div class="card-body col-lg-6 col-md-12">
                                                ...
                                                <span
                                                    class="badge bg-primary insideBadge">{{ $album->playcount }}</span>
                                                <h2>{{ $album->name }}</h2>
                                                <h3>{{ $album->artist->name }}</h3>
                                            </div>
                                        @endif
                                    ...
                                    @foreach($data->weeklyTracks->track as $track)
                                        @if($loop->index == 0)
                                            <div class="card-body col-lg-12">
                                                ...
                                                <span
                                                    class="badge bg-success insideBadge">{{ $track->playcount }}</span>
                                                <h2>{{ $track->name }}</h2>
                                        ...
                                        @else
                                            <div class="card-body col-lg-6 col-md-12">
                                                ...
                                                <span
                                                    class="badge bg-primary insideBadge">{{ $track->playcount }}</span>
                                                <h2>{{ $track->name }}</h2>
                                                <h3>{{ $track->artist->{"#text"} }}</h3>
                                            </div>
                                        @endif
